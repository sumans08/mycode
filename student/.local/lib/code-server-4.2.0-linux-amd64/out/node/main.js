...
const runCodeServer = (args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    logger_1.logger.info(`${protocol.toUpperCase()} server listening on ${serverAddress.toString()} ${args.link ? "(randomized by --link)" : ""}`);
    ...
    if (args.link) {
        yield (0, coder_cloud_1.coderCloudBind)(serverAddress, args.link.value);
