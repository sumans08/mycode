...
class CodeServerRouteWrapper {
    constructor() {
        ...
        this.ensureCodeServerLoaded = (req, _res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                this._codeServerMain = yield createVSServer(null, Object.assign(Object.assign({}, (yield (0, cli_1.toCodeArgs)(args))), { 
                    // TODO: Make the browser helper script work.
                    "without-connection-token": true, "without-browser-env-var": true }));
            }
            catch (error) {
        ...
        this._wsRouterWrapper.ws("/", http_1.ensureAuthenticated, this.ensureCodeServerLoaded, this.$proxyWebsocket);
    }
    get wsRouter() {
