...
const isWsl = () => __awaiter(void 0, void 0, void 0, function* () {
    return ((process.platform === "linux" && os.release().toLowerCase().indexOf("microsoft") !== -1) ||
        (yield fs_1.promises.readFile("/proc/version", "utf8")).toLowerCase().indexOf("microsoft") !== -1);
});
exports.isWsl = isWsl;
/**
...
const open = (address) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const args = [];
    const options = {};
    const platform = (yield (0, exports.isWsl)()) ? "wsl" : process.platform;
...
const buildAllowedMessage = (t) => {
    const values = (0, exports.enumToArray)(t);
